 ...
 *
 */
public class RaceWorldDomain implements DomainGenerator {
     ...
     */
    public RaceWorldDomain(int width, int height){
        this.width = width;
        this.height = height;
     ...
     */
    public RaceWorldDomain(int [][] map){
        this.setMap(map);
        this.setDeterministicTransitionDynamics();
    }
    ...
    public class WallToPF extends PropositionalFunction{
        ...
        public WallToPF(String name, String[] parameterClasses, int direction) {
            super(name, parameterClasses);
            int [] dcomps = RaceWorldDomain.this.movementDirectionFromIndex(direction);
            xdelta = dcomps[0];
            ydelta = dcomps[1];
        }
        ...
        public boolean isTrue(OOState st, String... params) {
            ...
            if(cx < 0 || cx >= RaceWorldDomain.this.width || cy < 0 || cy >= RaceWorldDomain.this.height || RaceWorldDomain.this.map[cx][cy] == 1 ||
                    (xdelta > 0 && (RaceWorldDomain.this.map[ax][ay] == 3 || RaceWorldDomain.this.map[ax][ay] == 4)) || (xdelta < 0 && (RaceWorldDomain.this.map[cx][cy] == 3 || RaceWorldDomain.this.map[cx][cy] == 4)) ||
                    (ydelta > 0 && (RaceWorldDomain.this.map[ax][ay] == 2 || RaceWorldDomain.this.map[ax][ay] == 4)) || (ydelta < 0 && (RaceWorldDomain.this.map[cx][cy] == 2 || RaceWorldDomain.this.map[cx][cy] == 4)) ){
                return true;
            }
    ...
    public static void main(String[] args) {
        ...
        RaceWorldDomain gwdg = new RaceWorldDomain(11, 11);
